...
public class CardService {
  ...
  public List<CustomerCardInfoDTO> getCustomerCardInfo(String accessToken) {
    ...
    try {
      ResponseEntity<CustomerCardInfoDTO[]> response = restTemplate.postForEntity(cardUrl, ciDTO,
          CustomerCardInfoDTO[].class);
  ...
  public List<CardCustomerApprovalDTO> getCardApprovalList(
    ...
    ResponseEntity<CardCustomerApprovalDTO[]> response = restTemplate.postForEntity(url,
        requestEntity, CardCustomerApprovalDTO[].class);

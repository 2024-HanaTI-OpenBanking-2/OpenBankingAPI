...
public class AuthController {
  ...
  public void authorize(
    ...
    try {
      String redirectUrl = authService.authorize2(response_type, client_id, redirect_uri, scope,
          state, ci, customer_id);
  ...
  public void showSendForm(@RequestParam("client_id") String clientId, HttpServletResponse response)
      throws IOException {
